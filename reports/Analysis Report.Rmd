...
"C:\Users\VAISHNAVI\Desktop\Futurelearn_mooc_data_analysis_project\Futurelearn"
...
for (comb in combinations) {
  ...
  num_students_with_incorrect_response_with_completion <- n_distinct(incorrect_response_with_completion$learner_id)
  ...
  num_students_with_correct_response_with_completion <- n_distinct(correct_response_with_completion$learner_id)
  
  # Store the result in the results list
  results[[paste("Week", comb$week_number, "Step", comb$step_number)]] <- data.frame(
    week = comb$week_number,
    step_number = comb$step_number,
    correct_complete = num_students_with_correct_response_with_completion,
    incorrect_complete = num_students_with_incorrect_response_with_completion
  )
}
